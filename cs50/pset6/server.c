...
{
    // TODO
    if(strcasecpm("css", extension) == 0) 
    {
        return "text/css";
    }
    
    if(strcasecpm("html", extension) == 0) 
    {
        return "text/html";
    }
    
    if(strcasecpm("gif", extension) == 0) 
    {
        return "image/gif";
    }
    
    if(strcasecpm("ico", extension) == 0) 
    {
        return "image/x-icon";
    }
    
    if(strcasecpm("jpg", extension) == 0) 
    {
        return "image/jpeg";
    }
    
    if(strcasecpm("js", extension) == 0) 
    {
        return "text/javascript";
    }
    
    if(strcasecpm("png", extension) == 0) 
    {
        return "image/png";
    }
    return NULL;
